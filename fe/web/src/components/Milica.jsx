...
function Milica() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(false);
        setResponse((curr) => [...curr, data.choices[0].message.content]);
    }
    // useEffect(()=>{
    //     handleSubmit();
    // }, [])
            ...
            <div className='w-[70vw] mt-[20vh]' ref={questionsRef}>
                ...
                <form className='flex mt-[10vh] flex-col justify-center items-center px-6  md:px-12' onSubmit={handleSubmit}>
                    ...
                    <div class="w-[80%] flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700" id="mihau"> 
                        <input onChange={handleQuestion} id="chat" rows="1" class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ask him something about money..."></input>
